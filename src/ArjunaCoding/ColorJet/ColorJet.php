...
use ArjunaCoding\ColorJet\Formats\HSV;
use ArjunaCoding\ColorJet\Formats\CIELCh;
use ArjunaCoding\ColorJet\Formats\RGB;

/**
 * ColorJet is the base class that all color objects extend
 *
 *
 * @author Arjuna Coding <arjuna@mischiefcollective.com>
 */
abstract class ColorJet
{
     ...
     *
     * @param \ArjunaCoding\ColorJet\ColorJet $destinationColor The destination color
     *
     * @return int distance to destination color
     */
    public function distance(ColorJet $destinationColor)
    {
        $a = $this->toCIELab();
     ...
     *
     * @return \ArjunaCoding\ColorJet\ColorJet The closest color
     */
     ...
     *
     * @param array $palette An array of ColorJet objects to match against
     *
     * @return \ArjunaCoding\ColorJet\ColorJet The closest color
     */
     ...
     *
     * @return \ArjunaCoding\ColorJet\ColorJet The greyscale color
     */
     ...
     *
     * @return \ArjunaCoding\ColorJet\ColorJet[] Array of complimentary colors
     */
    ...
    public function range(ColorJet $destinationColor, $steps, $includeSelf = false)
    {
        $a = $this->toRGB();
     ...
     *
     * @return \ArjunaCoding\ColorJet\ColorJet The modified color
     */
